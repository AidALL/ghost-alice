...
- [2. Color Palette & Roles](#2-color-palette-roles)
  - [Brand](#brand)
  - [Neutral Scale (Dark Mode)](#neutral-scale-dark-mode)
  - [Radix Color Tokens (HSL-based)](#radix-color-tokens-hsl-based)
...
**Key Characteristics:**
- Dark-mode-native: near-black backgrounds (`#0f0f0f`, `#171717`) Do not use pure black.
- Emerald green brand accent (`#3ecf8e`, `#00c573`) used sparingly as identity marker
- Circular font is geometric sans-serif with rounded terminals.
...
- Minimal shadows is Depth through border contrast and transparency.
...
- **Crimson**: `--colors-crimson4`, `--colors-crimsonA9` It is warm accent / alert.
- **Indigo**: `--colors-indigoA2` It is subtle blue wash.
- **Yellow**: `--colors-yellowA7` Attention/warning.
- **Tomato**: `--colors-tomatoA4` Error accent.
- **Orange**: `--colors-orange6` It is warm accent.
...
- **Monospace as ritual**: Source Code Pro in uppercase with 1.2px letter-spacing is the "developer console" voice. It is used sparingly for technical labels that connect to the product experience.
...
- Radius: 8px–16px
- No visible shadows is Borders define edges.
...
- Set hero text to 1.00 line-height. This means the zero-leading is the typographic signature.
...
4. Weight 400 is the default for everything is 500 only for interactive elements.
