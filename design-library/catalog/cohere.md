...
- 22px signature border-radius. This means the distinctive "Cohere card" roundness.
...
- **Near Black** (`#212121`): Standard body link color. It is slightly softer than pure black.
- **Deep Dark** (`#17171c`): A blue-tinted near-black for navigation and dark-section text.

### Secondary & Accent
- **Interaction Blue** (`#1863dc`): The primary interactive accent appears on button hover, focus states, and active links. It is the sole chromatic action color.
- **Ring Blue** (`#4c6ee6` at 50%): Tailwind ring color for keyboard focus indicators.
- **Focus Purple** (`#9b60aa`): Input focus border color is a muted violet.
...
### Neutrals & Text
- **Muted Slate** (`#93939f`): De-emphasized footer links and tertiary text is a cool-toned gray with a slight blue-violet tint.
...
- The primary button style is Invisible until interacted with.
...
- 26 breakpoints detected is Extremely granular responsive system.
...
*26 breakpoints detected. It is one of the most granularly responsive sites in the dataset.*
...
3. Specify the typeface is CohereText for headlines, Unica77 for body, CohereMono for labels.
4. Interactive elements use Interaction Blue (#1863dc) on hover only
5. Keep surfaces white with cool gray borders. There is no warm tones.
