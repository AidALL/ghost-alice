...
- [2. Color Palette & Roles](#2-color-palette-roles)
  - [Primary](#primary)
  - [Brand / Interactive](#brand-interactive)
  - [Semantic](#semantic)
...
Revolut's website is fintech confidence distilled into pixels. It is a design system that communicates "your money is in capable hands" through massive typography, generous whitespace, and a disciplined neutral palette. The visual language is built on Aeonik Pro, a geometric grotesque that creates billboard-scale headlines at 136px with weight 500 and aggressive negative tracking (-2.72px). This isn't subtle branding; it's fintech at stadium scale.

The color system is built on a comprehensive `--rui-*` (Revolut UI) token architecture with semantic naming for every state: danger (`#e23b4a`), warning (`#ec7e00`), teal (`#00a87e`), blue (`#494fdf`), deep-pink (`#e61e49`), and more. But the marketing surface itself is remarkably restrained. It is near-black (`#191c1f`) and pure white (`#ffffff`) dominate, with the colorful semantic tokens reserved for the product interface, not the marketing page.
...
**Key Characteristics:**
- Aeonik Pro display at 136px weight 500 is Billboard-scale fintech headlines.
...
- Zero shadows detected is Depth through color contrast only.
...
### Font Families
- **Display**: `Aeonik Pro` It is geometric grotesque, no detected fallbacks.
...
### Principles
- **Weight 500 as display default**: Aeonik Pro uses medium (500) for ALL headings. There is no bold. This creates authority through size and tracking, not weight.
...
- No shadows is Flat surfaces with color contrast.
...
### Iteration Guide
1. Aeonik Pro 500 for headings. Do not use bold weight.
2. All buttons are pills (9999px) with generous padding
3. Zero shadows is Flat is the Revolut identity.
4. It is near-black + white for marketing, semantic colors for product
