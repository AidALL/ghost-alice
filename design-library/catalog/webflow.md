...
- [3. Typography Rules](#3-typography-rules)
  - [Font: `WF Visual Sans Variable`, fallback: `Arial`](#font-wf-visual-sans-variable-fallback-arial)
- [4. Component Stylings](#4-component-stylings)
  - [Buttons](#buttons)
  - [Cards: `1px solid #d8d8d8`, 4px–8px radius](#cards-1px-solid-d8d8d8-4px8px-radius)
  - [Badges: Blue-tinted bg at 10% opacity, 4px radius](#badges-blue-tinted-bg-at-10-opacity-4px-radius)
- [5. Layout](#5-layout)
- [6. Depth: 5-layer cascading shadow system](#6-depth-5-layer-cascading-shadow-system)
- [7. Do's and Don'ts](#7-dos-and-donts)
- [8. Responsive: 479px, 768px, 992px](#8-responsive-479px-768px-992px)
...
- WF Visual Sans Variable is a custom variable font with weight 500–600.
- Rich secondary palette: purple `#7a3dff`, pink `#ed52cb`, green `#00d722`, orange `#ff6b00`, yellow `#ffae13`, red `#ee1d36`
- Conservative 4px–8px border-radius is sharp, not rounded.
