...
- [2. Color Palette & Roles](#2-color-palette-roles)
  - [Primary](#primary)
  - [Pastel Accents (Light/Dark pairs)](#pastel-accents-lightdark-pairs)
  - [Semantic](#semantic)
  - [Neutral](#neutral)
...
- [4. Component Stylings](#4-component-stylings)
  - [Buttons](#buttons)
  - [Cards: 12px–24px radius, pastel backgrounds](#cards-12px24px-radius-pastel-backgrounds)
  - [Inputs: white bg, `1px solid #e9eaef`, 8px radius, 16px padding](#inputs-white-bg-1px-solid-e9eaef-8px-radius-16px-padding)
