...
What makes Binance.US distinctive is the tension between warmth and precision. The golden yellow brand color. It is warm, optimistic, almost celebratory. Lives inside a system of cold, clinical grey text and razor-sharp borders. This isn't a playful fintech like Robinhood or a corporate fortress like Fidelity. It's a crypto-native platform that wraps cutting-edge trading technology in the visual language of established finance.

**Key Characteristics:**
- Two-tone light/dark section alternation is White surfaces for trust, dark panels for depth.
...
- **Golden Glow**: Radial gradient from `#F0B90B` center to `#F8D12F` edge It is used behind product mockup screenshots.
- **Dark Fade**: Linear gradient from `#222126` to transparent It is used for dark section transitions.
...
|------|------|--------|-------------|----------------|-------|
| Display Hero | 60px | 700 | 1.08 | none | Hero headlines, maximum impact |
| Display Secondary | 34px | 700 | 1.00 | none | Section titles on dark backgrounds |
| Heading 1 | 28px | 500 | 1.00 | none | Major section headings |
| Heading 2 | 24px | 700 | 1.00 | none | Feature headings, card titles |
| Heading 3 | 24px | 600 | 1.00 | none | Subsection headings |
| Heading 4 | 20px | 600 | 1.25 | none | Card headings, feature labels |
| Body Large | 20px | 500 | 1.50 | none | Hero subtitle, lead paragraphs |
| Body | 16px | 500 | 1.50 | none | Standard body text |
| Body SemiBold | 16px | 600 | 1.30 | none | Emphasized body, nav links |
| Body Bold | 16px | 700 | 1.50 | none | Strong emphasis text |
| Button | 16px | 600 | 1.25 | 0.16px | Primary button text |
| Button Small | 14.4px | 600 | 1.60 | 0.72px | Secondary buttons, wider tracking |
| Caption | 14px | 500 | 1.43 | none | Metadata, labels, prices |
| Caption SemiBold | 14px | 600 | 1.50 | none | Emphasized captions |
| Small | 12px | 600 | 1.00 | none | Tags, badges, fine print |
| Tiny | 11px | 500 | 1.00 | none | Micro-labels, chart annotations |
...
- Shadow: `rgba(32, 32, 37, 0.05) 0px 3px 5px 0px` It is barely visible, trust-building.
...
- Keep shadows at 5% opacity or less. It is barely there but present.
...
5. Numbers and data should be prominent is This is a financial platform.
