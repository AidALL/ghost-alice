...
- [2. Color Palette & Roles](#2-color-palette-roles)
  ...
  - [Base Color Spectrum (FDS)](#base-color-spectrum-fds)
...
- [4. Component Stylings](#4-component-stylings)
  ...
  - [Product-Specific Sections](#product-specific-sections)
...
- **Glimmer loading states**: Pulsating opacity animation (0.25 → 1.0) on `#979A9F` base color with 8px radius, 1000ms steps timing It is used for skeleton screens during product image loading.
...
- Let product photography dominate is Make images the visual hero of every section.
...
4. Describe the desired "feel" alongside specific measurements is "Generous whitespace like a gallery" means 64-80px section padding.
