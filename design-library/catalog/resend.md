...
- [2. Color Palette & Roles](#2-color-palette-roles)
  - [Primary](#primary)
  - [Accent Scale. Orange.](#accent-scale-orange)
  - [Accent Scale. Green.](#accent-scale-green)
  - [Accent Scale. Blue.](#accent-scale-blue)
  - [Accent Scale. Other.](#accent-scale-other)
...
- Commit Mono for code is Monospace as a design element, not an afterthought.
...
### Accent Scale. Orange.
- **Orange 4** (`#ff5900`): `--color-orange-4`, at 22% opacity It is subtle warm glow.
- **Orange 10** (`#ff801f`): `--color-orange-10`, primary orange accent. It is warm, energetic.
...
- **Aggressive negative tracking on display**: Domaine at -0.96px, ABC Favorit at -2.8px. The display type feels compressed, urgent, and designed It is like a magazine masthead.
- **Positive tracking on nav**: ABC Favorit nav links use +0.35px letter-spacing. It is the only positive tracking in the system. This creates airy, spaced-out navigation text that contrasts with the compressed headings.
...
- Minimal styling is Inherits dark theme.
...
- Dark-themed screenshots on dark background is Seamless integration.
...
- **Tight content, vast surrounds**: Text blocks and cards are compact internally, but float in vast dark space This creates isolated "islands" of content.
...
- No gradient backgrounds is Depth comes from border luminance and content contrast.
...
- Use +0.35px letter-spacing on ABC Favorit nav links. It is the only positive tracking.
...
2. Frost borders (`rgba(214, 235, 253, 0.19)`) are the universal structural element It is not gray, not neutral.
3. Three fonts, three roles: Domaine (hero), ABC Favorit (sections), Inter (body) Do not cross.
4. OpenType stylistic sets are mandatory on display fonts is They define the character.
