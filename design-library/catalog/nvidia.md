...
- [2. Color Palette & Roles](#2-color-palette-roles)
  ...
  - [Extended Brand Palette](#extended-brand-palette)
  - [Status & Semantic](#status-semantic)
...
- [8. Responsive Behavior (Extended)](#8-responsive-behavior-extended)
  - [Typography Scaling](#typography-scaling)
  - [Dark/Light Section Strategy](#darklight-section-strategy)
