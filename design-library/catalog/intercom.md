...
- [5. Layout Principles](#5-layout-principles)
  - [Spacing: 8px, 10px, 12px, 14px, 16px, 20px, 24px, 32px, 40px, 48px, 60px, 64px, 80px, 96px](#spacing-8px-10px-12px-14px-16px-20px-24px-32px-40px-48px-60px-64px-80px-96px)
  - [Border Radius: 4px (buttons), 6px (nav items), 8px (cards, containers)](#border-radius-4px-buttons-6px-nav-items-8px-cards-containers)
...
- Sharp 4px border-radius is Near-rectangular buttons and elements.
- Scale(1.1) hover with scale(0.85) active is Physical button interaction.
...
- Apply 4px radius on buttons. It is sharp geometry is the identity.
