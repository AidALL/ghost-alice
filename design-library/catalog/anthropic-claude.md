...
Claude's interface is a literary salon reimagined as a product page. It is warm, unhurried, and quietly intellectual. The entire experience is built on a parchment-toned canvas (`#f5f4ed`) that deliberately evokes the feeling of high-quality paper rather than a digital surface. Where most AI product pages lean into cold, futuristic aesthetics, Claude's design radiates human warmth, as if the AI itself has good taste in interior design.

The signature move is the custom Anthropic Serif typeface. It is a medium-weight serif with generous proportions that gives every headline the gravitas of a book title. Combined with organic, hand-drawn-feeling illustrations in terracotta (`#c96442`), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." The serif headlines breathe at tight-but-comfortable line-heights (1.10–1.30), creating a cadence that feels more like reading an essay than scanning a product page.
...
- Terracotta brand accent (`#c96442`) is warm, earthy, deliberately un-tech.
...
### Primary
- **Anthropic Near Black** (`#141413`): The primary text color and dark-theme surface. It is not pure black but a warm, almost olive-tinted dark that's gentler on the eyes. It is the warmest "black" in any major tech brand.
- **Terracotta Brand** (`#c96442`): The core brand color is a burnt orange-brown used for primary CTA buttons, brand moments, and the signature accent. It is deliberately earthy and un-tech.
...
### Secondary & Accent
- **Error Crimson** (`#b53333`): A deep, warm red for error states. It is serious without being alarming.
...
### Surface & Background
- **Parchment** (`#f5f4ed`): The primary page background is a warm cream with a yellow-green tint that feels like aged paper. The emotional foundation of the entire design.
- **Ivory** (`#faf9f5`): The lightest surface. It is used for cards and elevated containers on the Parchment background. It is barely distinguishable but creates subtle layering.
...
- **Dark Surface** (`#30302e`): Dark-theme containers, nav borders, and elevated dark elements. It is warm charcoal.
...
- **Olive Gray** (`#5e5d59`): Secondary body text is a distinctly warm medium-dark gray.
...
### Semantic & Accent
- **Border Cream** (`#f0eee6`): Standard light-theme border. It is barely visible warm cream, creating the gentlest possible containment.
...
### Principles
- **Serif for authority, sans for utility**: Anthropic Serif carries all headline content with medium weight (500), giving every heading the gravitas of a published title. Anthropic Sans handles all functional UI text, including buttons, labels, and navigation. It does this with quiet efficiency.
- **Single weight for serifs**: All Anthropic Serif headings use weight 500 There is no bold, no light. This creates a consistent "voice" across all headline sizes, as if the same author wrote every heading.
...
- The workhorse button is warm, unassuming, clearly interactive.
...
- The primary CTA. This means it is the only button with chromatic color.
...
- Focus: ring with Focus Blue (`#3898ec`) border-color. It is the only cool color moment.
- Radius: generously rounded (12px)
...
- The primary visual personality. There is no other AI company uses this style.
...
**Shadow Philosophy**: Claude communicates depth through **warm-toned ring shadows** rather than traditional drop shadows. The signature `0px 0px 0px 1px` pattern creates a border-like halo that's softer than an actual border. It's a shadow pretending to be a border, or a border that's technically a shadow. When drop shadows do appear, they're extremely soft (0.05 opacity, 24px blur). It is barely visible lifts that suggest floating rather than casting.
...
- **Warm ring halos**: Button and card interactions use ring shadows that match the warm palette. Do not use cool-toned or generic gray.
...
- Maintain the editorial serif/sans hierarchy. Use serif for content headlines, sans for UI.
...
2. Reference specific color names is "Use Olive Gray (#5e5d59)" not "make it gray".
3. Always specify warm-toned variants. There is no cool grays.
4. Describe serif vs sans usage explicitly is "Anthropic Serif for the heading, Anthropic Sans for the label".
5. For shadows, use "ring shadow (0px 0px 0px 1px)" or "whisper shadow" Do not generic "drop shadow".
6. Specify the warm background is "On Parchment (#f5f4ed)" or "on Near Black (#141413)".
