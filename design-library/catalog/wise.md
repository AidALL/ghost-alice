...
- **"calt" everywhere**: Contextual alternates enabled on ALL text. It applies to both Wise Sans and Inter.
- **Weight 600 as body default**: Inter Semibold is the standard reading weight. It is confident, not light.
...
### Iteration Guide
1. Wise Sans 900 at 0.85 line-height. This means the extreme weight is the brand.
...
4. "calt" on everything is Contextual alternates are mandatory.
5. Inter 600 for body is Confident reading weight.
