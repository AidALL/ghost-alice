...
- [2. Color Palette & Roles](#2-color-palette-roles)
  ...
  - [Text](#text)
  - [Surface & Dark Variants](#surface-dark-variants)
...
**Key Characteristics:**
- SF Pro Display/Text with optical sizing is Letterforms adapt automatically to size context.
...
- Product-as-hero photography on solid color fields There are no gradients, no textures, no distractions.
- Extremely tight headline line-heights (1.07-1.14) creating compressed, billboard-like impact
- Full-width section layout with centered content. This means the viewport IS the canvas.
...
### Image Treatment
- Products on solid-color fields (black or white) There are no backgrounds, no context, just the object.
...
- Minimal chrome. This means the products speak for themselves.
...
- Single-column for hero moments is One product, one message, full attention.
- No visible grid lines or gutters is Spacing creates implied structure.
...
- Compress headline line-heights to 1.07-1.14 is Apple headlines are famously tight.
...
### Iteration Guide
1. Every interactive element gets Apple Blue (`#0071e3`) There is no other accent colors.
2. Section backgrounds alternate: black for immersive moments, `#f5f5f7` for informational moments
3. Typography optical sizing: SF Pro Display at 20px+, SF Pro Text below Do not mix.
4. Negative letter-spacing at all sizes: -0.28px at 56px, -0.374px at 17px, -0.224px at 14px, -0.12px at 12px
5. The navigation glass effect (translucent dark + blur) is non-negotiable is It defines the Apple web experience.
6. Products always appear on solid color fields Do not on gradients, textures, or lifestyle backgrounds in hero modules.
7. Shadow is rare and always soft: `3px 5px 30px 0.22 opacity` or nothing at all
8. Pill CTAs use 980px radius is This creates the signature Apple rounded-rectangle-that-looks-like-a-capsule shape.
