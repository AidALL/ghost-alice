...
### Shadows
- Minimal shadow system is Depth through photography and dark/light section contrast.
...
- **Universal uppercase display**: The 60px hero is always uppercase This creates a monumental, architectural quality.
...
- No border-radius. It is sharp rectangular buttons.

### Cards & Containers
- No border-radius is All containers are sharp-cornered rectangles.
...
- **Compressed content**: Body text areas use tight line-heights and compact spacing. It is information-dense, no waste.
...
- Use BMW Blue (`#1c69d4`) only for interactive elements. Do not decoratively.
...
3. BMW Blue for interactive only Do not as background or decoration.
4. Photography carries emotion. This means the UI is pure precision.
5. Tight line-heights everywhere is 1.15 to 1.30 is the range.
