...
- [4. Component Stylings](#4-component-stylings)
  ...
  - [Keyboard Shortcut Keys](#keyboard-shortcut-keys)
...
### Primary
- **Near-Black Blue** (`#07080a`): Primary page background is the foundational void with a subtle blue-cold undertone.
...
- **Warm Glow**: `rgba(215, 201, 175, 0.05)` radial spread It is subtle warm ambient glow behind featured elements.
...
### Principles
- **Positive tracking on dark**: Unlike most dark UIs that use tight or neutral letter-spacing, Raycast applies +0.2px to +0.4px This creates an airy, readable feel that compensates for the dark background.
- **Weight 500 as baseline**: Most body text uses medium weight (500), not regular (400) It is subtle extra heft improves legibility on dark surfaces.
...
- Use `rgba(255, 255, 255, 0.06)` borders for card containment. It is barely visible, structurally essential.
...
- Mix warm and cool borders is Stick to the cool gray (`hsl(195, 5%, 15%)`) border palette.
...
5. Test that hover states use opacity transitions (0.6) not color swaps is This is a core interaction pattern.
