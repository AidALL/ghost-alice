...
### Primary
- **Replicate Dark** (`#202020`): The primary text color and dark surface is a near-black that's the anchor of all text and borders. Slightly warmer than pure #000.
- **Replicate Red** (`#ea2804`): The core brand color is a vivid, saturated orange-red used in the hero gradient, accent borders, and high-signal moments.
...
- **Weight 600 as emphasis**: When basier-square needs emphasis, it uses 600 (semibold) Do not use bold weight (700), which is reserved for rb-freigeist-neue display text.
...
- Use Replicate Dark (#202020) as the primary dark. It is not pure black.
...
### Iteration Guide
1. Everything is pill-shaped Do not specify any other border-radius.
2. Display text is HEAVY is Weight 700, sizes 48px+.
3. Links use dotted underline (#bbbbbb) Do not use solid.
4. The gradient hero is the visual anchor is Make it bold.
