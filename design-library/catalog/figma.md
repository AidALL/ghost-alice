...
- Strictly black-and-white interface chrome is Color exists only in product content.
...
- Negative letter-spacing throughout is Even body text at -0.14px to -0.26px.
...
2. Interface is always black + white Do not add colors to chrome.
