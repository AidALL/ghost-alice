...
- [2. Color Palette & Roles](#2-color-palette-roles)
  - [Primary](#primary)
  - [Neutral Scale (Gray Family)](#neutral-scale-gray-family)
  - [Interactive](#interactive)
  - [Support & Status](#support-status)
  - [Dark Theme (Gray 100 Theme)](#dark-theme-gray-100-theme)
...
**Key Characteristics:**
- IBM Plex Sans at weight 300 (Light) for display is Corporate gravitas through typographic restraint.
...
- 8px spacing grid with strict adherence There is no arbitrary values, everything aligns.
- Flat, borderless cards on `#f4f4f4` Gray 10 surface is Depth through background-color layering, not shadows.
- Bottom-border inputs (not boxed). This means the signature Carbon form pattern.
- 0px border-radius on primary buttons is Unapologetically rectangular, no softening.
...
- Border: none (flat design There is no border or shadow on most cards).
...
- No shadow is Flatness is the identity.
...
2. Letter-spacing only at small sizes: 0.16px at 14px, 0.32px at 12px Do not on display text.
3. Three weights: 300 (display), 400 (body), 600 (emphasis) There is no bold.
