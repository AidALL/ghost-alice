...
- Spotify Green (`#1ed760`) as singular brand accent. Do not use it decoratively, always functional.
...
- Album art as the primary color source. This means the UI is achromatic by design.
...
- Let album art provide color. This means the UI itself is achromatic.
...
3. Pill everything is 500px for large, 9999px for small, 50% for circular.
4. Uppercase + wide tracking on buttons. This means the systematic label voice.
5. Heavy shadows (0.3–0.5 opacity) for elevation Light shadows are invisible on dark.
6. Album art provides all the color. This means the UI stays achromatic.
