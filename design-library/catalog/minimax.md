...
- [2. Color Palette & Roles](#2-color-palette-roles)
  ...
  - [Blue Scale (Primary)](#blue-scale-primary)
...
- [4. Component Stylings](#4-component-stylings)
  ...
  - [AI Product Cards (Matrix)](#ai-product-cards-matrix)
  - [Links](#links)
...
What makes MiniMax distinctive is its pill-button geometry (9999px radius) for navigation and primary actions, combined with softer 8px–24px radiused cards for product showcases. The product cards themselves are richly colorful. Vibrant gradients in pink, purple, orange, and blue. This creates a "gallery of AI capabilities" feel. Against the white canvas, these colorful cards pop like app icons on a phone home screen, making each AI model/product feel like a self-contained creative tool.
...
4. DM Sans handles 70% of text is Outfit is display-only, Poppins is mid-tier only.
