...
function Invoke-Install {
    ...
    try {
        ...
        if ($copyOnly) {
            Write-Info "To update skills safely: cd $ScriptDir; .\install.cmd --update-source, then rerun .\install.cmd" "To update skills safely: cd $ScriptDir; .\install.cmd --update-source, then rerun .\install.cmd"
        } else {
            Write-Info "To update skills safely: cd $ScriptDir; .\install.cmd --update-source" "To update skills safely: cd $ScriptDir; .\install.cmd --update-source"
        }
